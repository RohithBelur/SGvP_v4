...
SUBROUTINE plbb2t15Fct(key, nodee, geome, matre, datae, eldt, ue, due, dt, incriT, DincriT, out1, out2, out3)
...
!
! Modified fortran element for plbb2t15.m
!
!
...
! INPUT -------------------------------------------------------------------------
    ...
    real*8, intent(in)                                                  :: eldt(48*datae(1))
...
! Workspace ---------------------------------------------------------------------
    ...
    real*8                                                      :: Ep, dEp, dg_dEp, gEp, delta_dEp(1,1), delta_Ep
    real*8                                                      :: sigmac, delta_Q(1,1), delta_rho_c(2,1), delta_rho(2,1)
    real*8                                                      :: delta_tau(2,1)
    real*8                                                      :: finte(15,1)
...
END SUBROUTINE plbb2t15Fct

END MODULE mod_plbb2t15Fct
