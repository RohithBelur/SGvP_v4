...
mex -c -g -O -largeArrayDims plte2t15Fct.F90 findDet.o gdndxi.o gintp.o gn.o inv.o
mex -g -O -largeArrayDims plte2t15.F90 plte2t15Fct.o findDet.o gdndxi.o gintp.o gn.o inv.o
...
# mex -c -g -O -largeArrayDims plcv2t12Fct.F90 findDet.o gdndxi.o gintp.o gn.o inv.o
# mex -g -O -largeArrayDims plcv2t12.F90 plcv2t12Fct.o findDet.o gdndxi.o gintp.o gn.o inv.o

echo "Mex compilation end"
